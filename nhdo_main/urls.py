...
urlpatterns = [
    ...
    url(r'whoweare/$', whoweare, name='whoweare'),
    url(r'^our_poineers/$', our_poineers, name='our_poineers'),
    url(r'visionm/$', visionm, name='visionm'),
    url(r'our_visionary/$', our_visionary, name='our_visionary'),
